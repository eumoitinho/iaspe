...
// This subdomain (capacitacao.iaspeconcursos.com.br) exists only for
// capacitações, so the course listing IS the home page. Every other menu item
// points back to the main portal.
